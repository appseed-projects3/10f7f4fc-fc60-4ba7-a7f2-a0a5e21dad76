...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-04-08 19:59`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/10f7f4fc-fc60-4ba7-a7f2-a0a5e21dad76.git
$ cd 10f7f4fc-fc60-4ba7-a7f2-a0a5e21dad76
```
